...
def logger_real(data):
    with open('textreal.txt', 'a') as f:
        f.write(data)
def logger_imag(data):
    with open('textimag.txt', 'a') as f:
        f.write(data)
    ...
    while not interrupt_handler.got_signal:
        ...
        if plot_data is not None:
            try:
                ...
                logger_real(str(plot_data["iq_val_real"])+"\n")
                logger_imag(str(plot_data["iq_val_imag"])+"\n")
    ...
    def process(self, sweep):
        ...
        if self.sweep_index == 0:
            ...
            plot_data = {
                ...
                "iq_val": iq_val,
                "iq_val_real": iq_val.real,
                "iq_val_imag": iq_val.imag,
            }
